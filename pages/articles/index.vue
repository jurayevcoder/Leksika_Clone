        ...
        <div class="flex flex-col gap-5 w-[738px]">
          ...
          <div class="flex gap-5 bg-white rounded-[18px] p-4">
            ...
            <div class="flex flex-col gap-5">
              ...
              <p>
                Chet tilini o’rganishda so’z boyligini doimiy ravishda boyitib borish,
                ya’ni ko’proq yangi so’zlarni yod olish, juda muhimdir. Biroq, hamma ham
                bu ishni uddalay olmaydi. So’z boyligini oshirish ...
              </p>
            </div>
          </div>
